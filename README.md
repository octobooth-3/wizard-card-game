...
- Your hand is at the **bottom**, the current trick is shown in the **middle**, and a
  running **log** on the right narrates everything that happens.
- Use the **Speed** control to slow down or speed up the bots.
...
- **Card play (bid-aware):** wins as cheaply as possible when still short of its bid, and
